...
# Replace the current path setup at the top with this:
...
CASH_LEDGER_FILE = os.path.join(BASE_DIR, 'data', 'cash_ledger.json')
PAYMENT_LEDGER_FILE = os.path.join(BASE_DIR, 'data', 'payment_ledger.json')
CREDIT_LEDGER_FILE = os.path.join(BASE_DIR, 'data', 'credit_ledger.json')
EXPENSES_LEDGER_FILE = os.path.join(BASE_DIR, 'data', 'expenses_ledger.json')
